...
% --- Colours ---
\definecolor{accent-blue}{RGB}{30, 80, 160}
...
% --- Section styling ---
\titleformat{\section}{\large\bfseries\color{accent-blue}}{}{0em}{}[\titlerule]
...
This document summarises the findings of an independent evaluation of the Bangla Text-to-Speech (TTS) system conducted by the AI Quality Assurance team. The evaluation assessed four interdependent components:
